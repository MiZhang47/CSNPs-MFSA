...
# xxx: C ring + A ring
B3 = "*OCC1=CxxxC1O"  # 5-ol-6,7-ene
B6 = "*OCC1=CxxxC1"  # 5-dehydro-6,7-ene
...
for idx, B in enumerate(B_fragments, 1):
    ...
    if '1' in B and '2' in B:
        ...
        for CA, c_part, a_part in CA_combinations[:20]:
...
replacement_dict = {'B1': 'B3', 'B2': 'B6'}

# Define the output path for the CSV file
path_csv = os.path.join('C:/Users/zhang/Desktop/StrucSimulation6/', 'D_67_ene(40).csv')
