...
Structural simulation for normal daphnane
"""
import csv
import os
...
# xxx: C ring + A ring
B1 = "*OCC12OC1xxxC2O"  # 5-ol-6,7-epoxy
B4 = "*OCC12OC1xxxC2"  # 5-dehydro-6,7-epoxy
...
for idx, B in enumerate(B_fragments, 1):
    ...
    if '1' in B and '2' in B:
        # If B contains '1' and '2', iterate through the first 40 elements of the CA_combinations list.
...
replacement_dict = {'B1': 'B1', 'B2': 'B4'}

# Define the output path for the CSV file
path_csv = os.path.join('C:/Users/zhang/Desktop/StrucSimulation6/', 'D_67_epo(40).csv')
